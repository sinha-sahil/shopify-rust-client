...
impl BulkOperation {
    ...
    /// This section
    /// Consumes a bulk operation JSONL result URL in constant memory by downloading
    /// in chunks and invoking the async callback with `batch_size` raw JSON lines at a time.
